...
export default function ZoneCard({ zone, onDelete }: ZoneCardProps) {
  ...
  return (
    <Link to={`/zones/${zone.domain}`} className="zone-card block bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-teal-500/50">
      ...
      <div className="mt-4 flex justify-between text-sm text-gray-500">
        ...
        <span className="text-teal-400 hover:text-teal-300">Manage Records →</span>
      </div>
    </Link>
  );
}
